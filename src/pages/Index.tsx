          ...
          <div className="md:col-span-1 space-y-6">
            <div className="flex flex-col items-center gap-4 sticky top-10">
              <img 
                src="/cidmoreira.png" 
                alt="Cid Moreira" 
                className="w-48 h-48 rounded-full object-cover border-2 border-primary/20 object-top"
              />
              <div className="text-center">
                <h1 className="text-3xl font-serif text-primary">
                  Recados da Bíblia
                </h1>
                <h3 className="text-lg font-medium text-primary/80 mt-2">
                  The God's Voice na voz eterna de
                  <br />
                  Cid Moreira
                </h3>
              </div>
